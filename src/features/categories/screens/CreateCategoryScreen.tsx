...
type CreateCategoryFormProps = {
    ...
    onSubmit: (data: SchemaCategoryForm) => Promise<any>;
...
type navigationProps = StackNavigationProp<AppStackParamList, 'CreateCategory'>
...
const CreateCategoryScreen = ({control, handleSubmit, errors, isSubmitting, setValue, watch, onSubmit, onCreated}: CreateCategoryFormProps) => {
    ...
    const createCategory = async (data: SchemaCategoryForm) => {
        await onSubmit(data)
        onCreated && onCreated()
        navigation.goBack()
    }
        ...
        <View style={styles.container}>
            ...
            <View style={styles.subcontainer}>
                ...
                <Button
                    ...
                    onPress={handleSubmit(createCategory)} 
                />
